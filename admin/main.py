...
from admin.draft_job_runtime import install as install_durable_draft_jobs
...
# Drafting is a durable server-side job: browser/network disconnects no longer
# destroy Claude/GPT results or couple the two parallel legs to one HTTP stream.
install_durable_draft_jobs(app_module)
app = app_module.app
