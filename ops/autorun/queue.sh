#!/bin/bash
# أمر آلي 44: (أ) كسر تخزين CDN المؤقت في pull.sh (ب) تثبيت كل عناوين الكتب 5-19 معاً
set -e
...
echo ""
echo "== (ب) تثبيت كل عناوين الكتب 5-19 =="
$PY - <<'PYEOF'
# -*- coding: utf-8 -*-
import sys
