#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""مُدخِل كتاب بورصات الأوراق المالية ووكالات المقاصة (الكتاب الرابع من اللائحة التنفيذية 7/2010).

المصدر: نصٌّ منقول يدويًا من الصفحات المُصوَّرة للـPDF الرسمي (طبقتا النصّ في
DOCX/PDF تالفتان) ⇒ النقل البصري هو المصدر الوحيد الدقيق. 159 مادة في 5 فصول
+ 3 ملاحق، بلا تلف ولا نقص.
...
BOOK_TT  = "بورصات الأوراق المالية ووكالات المقاصة"
...
def main():
    ...
    print("== تقرير كتاب بورصات الأوراق المالية ووكالات المقاصة (الكتاب الرابع) ==")
