...
LAW_ID = "legis-17-1960"
LAW_NO, LAW_YEAR = 17, 1960
LAW_TAG = "الإجراءات والمحاكمات الجزائية (17/1960)"
BRANCH = "جزائي"
INSTRUMENT = "القانون رقم 17 لسنة 1960 بإصدار قانون الإجراءات والمحاكمات الجزائية"
TOPIC = "الإجراءات والمحاكمات الجزائية"

PREAMBLE = (
    "القانون رقم 17 لسنة 1960 بإصدار قانون الإجراءات والمحاكمات الجزائية\n"
    "ينظّم التنظيم القضائي الجزائي (محاكم الجنح والجنايات والاستئناف)، والاختصاص، والتحريات "
    "والتحقيق الابتدائي، وأوامر الحضور والقبض والتفتيش والإجراءات التحفظية والحبس الاحتياطي، "
    "والدعوى الجزائية وتحريكها والادعاء المدني، وإجراءات المحاكمة والأحكام، وطرق الطعن "
    "(الاستئناف والاستئناف العليا)، وتنفيذ الأحكام ورد الاعتبار، في 250 مادة."
)
...
def build_rows(data):
    ...
    def meta(extra=None):
        d = {"instrument": INSTRUMENT, "instrument_rank": "قانون", "law_number": LAW_NO,
             "law_year": LAW_YEAR, "upload_origin": "docx_law17_parser"}
        if extra:
            d.update(extra)
        return d
...
def main():
    ...
    print("== تقرير الإجراءات الجزائية (17/1960) ==")
