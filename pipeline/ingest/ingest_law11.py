...
LAW_ID = "legis-11-2026"
LAW_NO, LAW_YEAR = 11, 2026
LAW_TAG = "الحماية من العنف الأسري (11/2026)"
BRANCH = "جزائي"
INSTRUMENT = "المرسوم بقانون رقم 11 لسنة 2026 في شأن الحماية من العنف الأسري"
TOPIC = "الحماية من العنف الأسري"

PREAMBLE = (
    "المرسوم بقانون رقم 11 لسنة 2026 في شأن الحماية من العنف الأسري\n"
    "ينشئ منظومة الحماية من العنف الأسري: تعريف العنف الأسري وأفراد الأسرة، واللجنة الوطنية "
    "للحماية من العنف الأسري، ومراكز إيواء المعتدى عليهم، وآليات التبليغ والإحالة وتسوية النزاع "
    "الأسري، وأوامر الحماية وإجراءات إصدارها والتظلم منها ومدّها، ويجرّم مخالفة أمر الحماية "
    "والبلاغ الكاذب وإفشاء البيانات. يلغي القانون رقم 16 لسنة 2020. صدر سنة 2026."
)
...
def build_rows(data):
    ...
    def meta(extra=None):
        d = {"instrument": INSTRUMENT, "instrument_rank": "قانون", "law_number": LAW_NO,
             "law_year": LAW_YEAR, "upload_origin": "docx_law11_parser", "repeals": "legis-16-2020"}
        if extra:
            d.update(extra)
        return d
...
def main():
    ...
    print("== تقرير الحماية من العنف الأسري (11/2026) ==")
