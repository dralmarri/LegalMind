#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""مُدخِل القانون رقم 68 لسنة 2015 في شأن العمالة المنزلية.

المصدر: DOCX رسمي بطبقة نصّ سليمة (استُخرج آليًا وروجع). 54 مادة في تسعة أبواب.
معرّفات المواد: legis-68-2015-m{N}. الديباجة: legis-68-2015-preamble.
النوع legislation_article، الفرع «عمل».
"""
from __future__ import annotations
import argparse, json, os, re, sys

LAW_ID   = "legis-68-2015"
LAW_NO   = 68
LAW_YEAR = 2015
LAW_TAG  = "قانون العمالة المنزلية (68/2015)"
BRANCH   = "عمل"
INSTRUMENT = "القانون رقم 68 لسنة 2015 في شأن العمالة المنزلية"

PREAMBLE = (
    "القانون رقم 68 لسنة 2015 في شأن العمالة المنزلية\n"
    "بعد الاطلاع على الدستور، وعلى المرسوم بالقانون رقم (17) لسنة 1959 بشأن قانون إقامة "
    "الأجانب والقوانين المعدلة له، وعلى القانون رقم (16) لسنة 1960 بإصدار قانون الجزاء "
    "والقوانين المعدلة له، وعلى القانون رقم (17) لسنة 1960 بإصدار قانون الإجراءات "
    "والمحاكمات الجزائية والقوانين المعدلة له، وعلى المرسوم بالقانون رقم (38) لسنة 1980 "
    "بإصدار قانون المرافعات المدنية والتجارية والقوانين المعدلة له، وعلى المرسوم بالقانون "
    "رقم (40) لسنة 1992 بشأن تنظيم مكاتب تشغيل الخدم الخصوصيين ومن في حكمهم، وعلى القانون "
    "رقم (91) لسنة 2013 في شأن مكافحة الإتجار بالبشر وتهريب المهاجرين، وعلى القانون رقم "
    "(111) لسنة 2013 في شأن تراخيص المحلات التجارية. وافق مجلس الأمة على القانون التالي نصه:"
)
