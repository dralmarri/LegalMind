#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""محلّل القانون رقم 31 لسنة 1970 بتعديل بعض أحكام قانون الجزاء (جرائم أمن الدولة + الرشوة).
...
SRC = sys.argv[1] if len(sys.argv) > 1 else "law17.docx"
OUT = sys.argv[2] if len(sys.argv) > 2 else "law31_parsed.json"
...
bound = next(i for i, p in enumerate(paras) if p.strip().startswith("الباب الأول"))
...
print("=== القانون 31/1970 (تعديل قانون الجزاء) ===")
