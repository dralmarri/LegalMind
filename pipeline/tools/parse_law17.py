#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""محلّل قانون الإجراءات والمحاكمات الجزائية 17/1960 (جرائم أمن الدولة + الرشوة).
...
SRC = sys.argv[1] if len(sys.argv) > 1 else "law_proc.docx"
OUT = sys.argv[2] if len(sys.argv) > 2 else "law17_parsed.json"
...
print("=== قانون الإجراءات الجزائية 17/1960 ===")
...
for k in ("m1", "m3", "m22-mukarrar", "m150", "m250"):
    if k in arts:
        print(f"\n--- {k} (sec={arts[k]['sec']}) ---\n{arts[k]['text'][:160]}")
